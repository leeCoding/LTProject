...
//{
//    return [BARegularExpression lt_isChinaMobile:phoneNum]? @"中国移动": ([BARegularExpression lt_isChinaUnicom:phoneNum]? @"中国联通":([BARegularExpression lt_isChinaTelecom:phoneNum]? @"中国电信": @"未知号码"));
//}
