...
- (UIImage*)lt_rotate:(UIImageOrientation)orient
{
    ...
    switch (orient)
    {
            ...
            case UIImageOrientationLeft:
            bnds = lt_swapWidthAndHeight(bnds);
...
{
    return [self lt_rotate:UIImageOrientationDownMirrored];
}

/** 水平翻转 */
- (UIImage *)lt_flipHorizontal
{
    return [self lt_rotate:UIImageOrientationUpMirrored];
}
...
{
    return [self lt_imageRotatedByRadians:kDegreesToRadian(degrees)];
}

/** 交换宽和高 */
static CGRect lt_swapWidthAndHeight(CGRect rect)
{
